...
<tr valign="top">
	<td>
		<h3><?php _e( 'CLC Object Storage Settings', 'as3cf' ); ?></h3>
		...
		<label for="virtual-host"> <?php _e( 'Bucket is setup for virtual hosting', 'as3cf' ); ?></label>
		<br />
...
<tr valign="top">
	<td>
		...
		<label for="copy-to-s3"> <?php _e( 'Copy files to CLC Object Storage as they are uploaded to the Media Library', 'as3cf' ); ?></label>
		<br />

		<input type="checkbox" name="serve-from-s3" value="1" id="serve-from-s3" <?php echo $this->get_setting( 'serve-from-s3' ) ? 'checked="checked" ' : ''; ?> />
		<label for="serve-from-s3"> <?php _e( 'Point file URLs to CLC Object Storage for files that have been copied to CLC Object Storage', 'as3cf' ); ?></label>
		<br />
		...
		<label for="remove-local-file"> <?php _e( 'Remove uploaded file from local filesystem once it has been copied to CLC Object Storage', 'as3cf' ); ?></label>
		<br />
		...
		<label for="hidpi-images"> <?php _e( 'Copy any HiDPI (@2x) images to CLC Object Storage (works with WP Retina 2x plugin)', 'as3cf' ); ?></label>
