...
class Amazon_Web_Services extends AWS_Plugin_Base {
	...
	function __construct( $plugin_file_path ) {
		...
		$this->plugin_title = __( 'CLC Object Storage', 'amazon-web-services' );
		$this->plugin_menu_title = __( 'CLC Object Storage', 'amazon-web-services' );
	}
	...
	function get_client() {
		if ( !$this->get_access_key_id() || !$this->get_secret_access_key() ) {
			return new WP_Error( 'access_keys_missing', sprintf( __( 'You must first <a href="%s">set your CLC Object Storage access keys</a> to use this addon.', 'amazon-web-services' ), 'admin.php?page=' . $this->plugin_slug ) );
		}
