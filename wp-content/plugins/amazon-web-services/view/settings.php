<div class="aws-content aws-settings">
	...
	<p>
		<?php _e( 'You&#8217;ve already defined your CLC Object Storage access keys in your wp-config.php. If you&#8217;d prefer to manage them here and store them in the database (not recommended), simply remove the lines from your wp-config.', 'amazon-web-services' ); ?>
	</p>
